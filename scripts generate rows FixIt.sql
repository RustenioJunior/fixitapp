...
INSERT INTO
  company (name, nif, address, email, phone, ative, current_date, modify_date, location_reference, postal_code)
SELECT
  'Company ' || i AS name,
  'NIF' || i AS nif,
  ...
  true AS ative,
  CURRENT_DATE - (TRUNC(RANDOM() * 1825)::int) AS current_date, -- Datas aleatórias nos últimos 5 anos
